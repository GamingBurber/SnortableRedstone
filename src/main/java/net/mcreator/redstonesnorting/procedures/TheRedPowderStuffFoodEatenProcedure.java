	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RedstonesnortingMod.LOGGER.warn("Failed to load dependency x for procedure TheRedPowderStuffFoodEaten!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RedstonesnortingMod.LOGGER.warn("Failed to load dependency y for procedure TheRedPowderStuffFoodEaten!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RedstonesnortingMod.LOGGER.warn("Failed to load dependency z for procedure TheRedPowderStuffFoodEaten!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RedstonesnortingMod.LOGGER.warn("Failed to load dependency world for procedure TheRedPowderStuffFoodEaten!");
			return;
		}
